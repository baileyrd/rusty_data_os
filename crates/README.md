...
- what hypothesis or requirement it addresses;
- what evidence supports its design;
- what correctness semantics it guarantees;
- what benchmark regressions it must avoid;
- what ADR/specification governs its stable behavior.

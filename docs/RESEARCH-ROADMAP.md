...
**Current substate:** planning/readiness. EXP-0001 is proposed, is not ready to execute, and has no implementation or experimental evidence. Its [execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md) controls the remaining decisions and gates. R1–R7 are complete documentation inputs. The [R7 authority](experiments/EXP-0001/R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) freezes benchmark-record serialization, artifact/provenance, instrumentation/overhead, fault-apparatus design, and future harness role boundaries without implementation or evidence. The R5 authorities freeze B0/B1 framing, integrity, and recoverable commit. The [R6 SQLite/RocksDB authority](experiments/EXP-0001/R6-SQLITE-ROCKSDB-EXECUTION-PROFILES.md) resolves BLK-018 and the B2/B3 design portion of BLK-019 with exact identities, profiles, mappings, and conditional/diagnostic classifications. BLK-015, toolchain/implementation/evidence gates, and empirical equivalence remain open. R8 is next but has not begun; its benchmark matrix, thresholds, and statistical plan remain open. No implementation, execution, or durability claim is authorized.

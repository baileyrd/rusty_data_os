...
## R34 checkpoint: R33 implementation conflict and v2 correction

[R34](experiments/EXP-0001/R34-R33-IMPLEMENTATION-CONFLICT-AND-TARGET-PREFLIGHT-V2-DECISION.md) records that closed, unmerged PR #114 exact head `41d30f3484609b6b6ec03918bfd04b03ac56273a` was not mergeable: R33 v1 lacks truthful unsupported-target and ownership-not-acquired representations, and the head did not meet the exhaustive synthetic gate. PR #114 is not evidence and created no public compatibility obligation. R34 preserves v1 and freezes a separate v2 schema, exact public Rust boundary, mismatch/acquisition/lifecycle semantics, and a complete synthetic test matrix. Exactly one later v2 implementation PR is authorized. Live use, host observation, workloads, records, tracefs, execution, evidence, performance, durability, baselines, and production remain blocked.

...
| EXP-0001 | RQ-003; HYP-0001 (partial future evidence only); [execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md); R1–R24 authorities | Proposed; bounded correctness slices are closed; R23 closes reference-context governance and R24 prospectively authorizes only the pending bounded pure implementation, while live Linux capture, BLK-015, D2/D3, apparatus, execution, benchmarks, production, and later slices remain gated |

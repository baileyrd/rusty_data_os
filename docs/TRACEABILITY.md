...
| EXP-0000 | RQ-002; EXP-0001 prerequisites; [single-event semantic envelope](experiments/EXP-0000/SEMANTIC-EVENT-ENVELOPE.md); [acknowledgement, visibility, fault, and durability contract](experiments/EXP-0000/ACKNOWLEDGEMENT-VISIBILITY-DURABILITY.md); [crash/recovery correctness contract](experiments/EXP-0000/CRASH-RECOVERY-CORRECTNESS.md) | Running; envelope, lifecycle/durability, and crash/recovery outputs complete; remaining outputs incomplete |

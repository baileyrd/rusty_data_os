...
| EXP-0001 | RQ-003; HYP-0001 (partial future evidence only); [execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md); R1–R26 authorities | Proposed; bounded correctness slices are closed; R26 freezes and prospectively authorizes the bounded v2 conformance/validator increment required by R25, while live Linux capture, BLK-015, D2/D3, apparatus, execution, benchmarks, production, and later slices remain gated |

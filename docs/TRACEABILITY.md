...
| EXP-0000 reproducible workload contract | REQ-003 through REQ-010, REQ-013, REQ-014; RQ-002; EXP-0001 workload and baseline fairness | Measurement-readiness input; freezes deterministic sizes, distributions, content/envelope/temporal profiles, matrix rules, and logical manifest fields without selecting physical generation, encoding, time, or serialization mechanisms |

...
| [EXP-0004](EXP-0004-entity-relation-domains.md) | Ready | Independent Entity/Relation domains on unchanged uc-core; canonical payloads, incarnation, retained labels, checkpoint/replay and independent correctness models; cross-domain atomicity Deferred. |

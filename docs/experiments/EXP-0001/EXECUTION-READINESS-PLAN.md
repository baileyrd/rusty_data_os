...
| BLK-009 | Workload-manifest physical serialization | Resolved as documentation design by [R16](R16-WORKLOAD-MANIFEST-SERIALIZATION-CONTRACT.md); manifest and validator implementation absent | BLK-006–BLK-008 | UNK-019 | Versioned serialization and fail-closed validator rules | Descriptive execution |

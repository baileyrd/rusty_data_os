...
| BLK-010 | Benchmark-record physical serialization and validation | Resolved as documentation design by [R7](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md); implementation and evidence remain gated | BLK-008, BLK-025 | UNK-022 | Versioned serialization, validation and correction rules | Result admissibility |
...
| BLK-016 | B0 implementation profile | Resolved as documentation design by [R5](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md); process-local sequencing is intentionally D0-only; implementation/evidence gated | BLK-001, BLK-006–BLK-007 | UNK-020 | Exact lower-bound operations and accounting | Slice B/baseline validation |
...
| BLK-020 | Benchmark harness architecture | Open; [R7](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) freezes role/interface boundaries only; R9 retains architecture and implementation choices | BLK-009–BLK-010, BLK-019 | UNK-020, UNK-022 | Experimental component and dependency-boundary design | Code authorization |
| BLK-021 | Instrumentation and overhead method | Resolved as documentation design by [R7](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md); calibration and numeric R8 limits remain gated | BLK-014, BLK-020 | UNK-022 | Named instruments, scope, calibration/bounding and loss rules | Descriptive/confirmatory execution |
| BLK-022 | Fault-injection mechanisms | Resolved as apparatus design by [R7](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md); implementation, apparatus validation, execution, and evidence remain gated | BLK-013–BLK-015, BLK-017–BLK-019 | UNK-015, UNK-021 | Injection-point mapping, apparatus validation and coverage | Recovery readiness |
...
| BLK-025 | Artifact storage and retention | Resolved as documentation design by [R7](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md); provider selection, implementation, and evidence remain gated | BLK-008, repository constraints | UNK-019, UNK-022 | Layout, durable references, retention/redaction and supersession rules | Execution/result admissibility |
...
R4 is complete for conditional planning through the owner-approved [target and platform durability evidence boundary](R4-FEDORA-44-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md). BLK-014 is closed for that planning purpose; BLK-015 remains open for dependent claims and execution. R5 completes B0/B1 design and resolves BLK-001/003/016/017. [R6](R6-SQLITE-ROCKSDB-EXECUTION-PROFILES.md) completes B2/B3 design, resolving BLK-018 and the remaining design portion of BLK-019 without empirical proof. The [R7 apparatus authority](R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) completes record serialization, artifact/provenance, instrumentation/overhead, and fault-mechanism design without implementation or evidence. The **one next readiness action** is documentation-only R8; no R8 matrix, threshold, or statistical content begins here. No capture, Cargo bootstrap, implementation, fixture, validator, adapter, descriptive execution, confirmatory execution, benchmark, fault action, machine change, or durability claim is authorized.

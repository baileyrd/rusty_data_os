...
| BLK-015 | Filesystem/storage stack and platform durability contract | Open for dependent claims/execution; planning-unblocked for conditional R5 design by [R4](R4-FEDORA-44-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md); final placement, PLP/protection, API profile, and empirical survival remain unverified | BLK-014 | UNK-014, UNK-021 | Stack-specific D2/D3 promise and limits | Canonical D2/D3 claims and execution, not conditional R5 design |
| BLK-016 | B0 implementation profile | Resolved at design level by [R5](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md); implementation/evidence gated | BLK-001, BLK-006–BLK-007 | UNK-020 | Exact lower-bound operations and accounting | Slice B/baseline validation |
| BLK-017 | B1 append and synchronization APIs | Resolved at design level by [R5](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md); BLK-015/evidence gated | BLK-013–BLK-015 | UNK-014, UNK-020 | API/error/sync/grouping profile and mapping | Slices C–E |
...
| BLK-019 | Adapter mappings for every baseline | B0/B1 portions design-resolved by [R5](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md); B2/B3 and evidence open | BLK-001, BLK-004–BLK-005, BLK-011–BLK-012, BLK-016–BLK-018 | UNK-020, UNK-021 | Versioned semantic-to-physical mapping and equivalence classification per baseline | Baseline equivalence |
...
| R4 — target environment and platform durability (**complete for conditional planning**) | What exact stack is studied and what can D2/D3 claim? Inputs: environment template and platform primary sources/research. | [Owner-approved evidence boundary, selected-target profile, conditional platform contract, sources, and fault matrix](R4-FEDORA-44-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md). BLK-014 is closed for R4 planning; BLK-015 remains open for dependent claims and execution. | Repository-retained provenance, final path placement, PLP/protection, API selection, empirical survival and performance claims. | Conditional planning boundary reviewed; no D2/D3 survival promise and **no code**. | Source/cross-reference and contract-to-fault matrix review. | Later evidence contradicts the profile, final paths are created/remounted, or stack/configuration changes. |
| R5 — B0/B1 physical profiles and adapter contracts (**complete as documentation design**) | What conditional lower bounds and OS operations preserve the declared cells? Inputs: R1–R4 and baseline contract. | [R5 authority](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md) resolving BLK-016/017 and B0/B1 portions of BLK-019 at design level, with placement/PLP/survival preconditions explicit. | SQLite/RocksDB details; implementation, execution, final placement, PLP/protection verification, and empirical survival. | Profiles reviewed for equivalence; **documentation only, no code or execution**. | Mapping and error-path table review. | An API cannot meet the intended D-mode or assumes an unverified physical fact. |
...
R4 is complete for conditional planning through the owner-approved [target and platform durability evidence boundary](R4-FEDORA-44-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md). BLK-014 is closed for that planning purpose; BLK-015 remains open for dependent D2/D3 claims and execution. [R5](R5-B0-B1-PHYSICAL-PROFILES-AND-ADAPTER-CONTRACTS.md) is complete as documentation design. The **one next readiness action** is R6 SQLite/RocksDB execution-profile documentation; no R6 content begins here. No further capture, Cargo bootstrap, implementation, fixture, validator, adapter, descriptive execution, confirmatory execution, benchmark, fault action, or durability claim is authorized.

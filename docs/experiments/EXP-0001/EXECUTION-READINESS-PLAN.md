...
### R33 target-preflight implementation branch

The R33-authorized target-preflight module, typed artifact, deterministic serializer, separate retention result, and synthetic injected tests are present on this branch. They remain pending exact-head external review and CI and therefore are not closed correctness evidence or authority for live use. Every R33 exclusion remains unchanged.

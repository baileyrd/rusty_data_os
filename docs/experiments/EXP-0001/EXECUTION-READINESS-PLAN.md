...
| BLK-014 | Target OS and hardware/environment | Open; target selected and evidence requirements defined by [R4](R4-FEDORA-43-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md), owner capture pending | — | UNK-014, UNK-020 | Reviewed target and completed environment record | Physical API research; series freeze |
| BLK-015 | Filesystem/storage stack and platform durability contract | Open; conditional contract defined by [R4](R4-FEDORA-43-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md), exact stack and empirical evidence pending | BLK-014 | UNK-014, UNK-021 | Stack-specific D2/D3 promise and limits | Canonical D2/D3 claims |
...
| R4 — target environment and platform durability (**documentation complete; evidence pending**) | What exact stack is studied and what can D2/D3 claim? Inputs: environment template and platform primary sources/research. | [Selected-target profile, conditional platform contract, capture procedure, sources, and fault matrix](R4-FEDORA-43-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md). BLK-014/015 remain open because exact owner capture and stack evidence are absent. | Exact machine/filesystem/storage/cache/PLP evidence, baseline binaries, API selection, empirical survival and performance claims. | Vocabulary and evidence gate reviewed for the selected target; no D2/D3 survival promise and **no code**. | Source/cross-reference and contract-to-fault matrix review. | Owner evidence completes or contradicts the profile, or stack/configuration changes. |
...
R4 is documentation-complete through the [target and platform durability contract](R4-FEDORA-43-BOSGAME-M5-TARGET-AND-PLATFORM-DURABILITY-CONTRACT.md), but BLK-014/015 remain open. The **one next readiness action** is owner capture and repository review of the exact target evidence; this is not R5 authorization. No Cargo bootstrap, implementation, fixture, validator, descriptive execution, or confirmatory execution is authorized.

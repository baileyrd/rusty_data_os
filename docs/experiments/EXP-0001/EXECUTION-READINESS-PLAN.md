...
| BLK-020 | Benchmark harness architecture | Resolved by R9 only for Slice A and extended through the three reviewed correctness crates; R19 freezes a maximum descriptive D1 candidate; R30 closes the merged R29-authorized fourth-crate preflight implementation and authorizes only its deterministic counter-ABI extension, while executable capture/harness architecture remains gated | BLK-009–BLK-010, BLK-019 | UNK-020, UNK-022 | Experimental component and dependency-boundary design | Slice A authorization; later slices separately gated |
| BLK-021 | Instrumentation and overhead method | Partially designed by R7; R30 closes the R29 preflight implementation and freezes only four counter-read perf events; tracefs, overhead/loss, live implementation use, and effective capture remain open | BLK-014, BLK-020 | UNK-022 | Named instruments, scope, calibration/bounding and loss rules | Descriptive/confirmatory execution |
...
| BLK-026 | Reproducible toolchain/build configuration | Resolved through the existing three-member Rust 1.89.0 correctness workspace; R30 closes the fourth-crate preflight subset and prospectively extends it only with deterministic counter-ABI code/tests; later/native/benchmark-series builds remain open | BLK-014, BLK-018 | UNK-020, UNK-022 | Rust 1.89.0, target, flags, lock/build identity and offline reproduction procedure | Slice A authorization; series separately gated |
| BLK-027 | Cargo/workspace and CI bootstrap authorization | Resolved through the reviewed three-member workspace; R30 closes that fourth member and authorizes only its non-live deterministic counter-ABI extension, not executable capture expansion | BLK-020, BLK-026, section 6 | UNK-020, UNK-022 | Reviewed layout, empty dependency allowlist, exact CI plan, and approval record | First Slice A code creation after R9 merge |

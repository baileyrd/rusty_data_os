...
The pure mapper and its deterministic correctness tests now provide bounded implementation/correctness-validation evidence for that mapping contract. No append/reopen integration or execution was added, and the live Linux capture blocker and all stated exclusions remain unchanged.

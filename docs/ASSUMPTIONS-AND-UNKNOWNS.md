...
| UNK-008 | R8 freezes the bounded candidate-primary matrix, threshold fields, and statistical plan, but quantitative practical-value thresholds remain unresolved. The exact accountable-owner decision is recorded in the R8 authority; affected cells remain descriptive and confirmatory interpretation is blocked rather than assigned invented values. |
...
| UNK-022 | R7 resolves benchmark-record JCS serialization, timestamp/number rules, SHA-256 record/artifact domains, artifact retention/provenance, and instrumentation as documentation design. Executable schemas/validators, effective validation, toolchain, capture, and evidence remain open. |

The [EXP-0001 execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md) maps unknowns to gates. R5 resolves UNK-001 and the B1 physical/integrity portion of UNK-012. R6 narrows UNK-020/021. [R7](experiments/EXP-0001/R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) narrows UNK-015/018/019/022 without empirical proof. R7 is complete at its owner-dependency boundary; R8 remains incomplete at its explicit owner threshold-decision boundary and R9 is not next; BLK-015, implementation, effective validation, execution, and evidence remain open.

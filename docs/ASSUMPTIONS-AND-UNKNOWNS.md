...
R34 records the governance conflict found at PR #114 exact head `41d30f3484609b6b6ec03918bfd04b03ac56273a`: green workflows do not make its invented v1 states or incomplete synthetic coverage mergeable. It preserves R33 v1 and freezes a distinct v2 correction with truthful unsupported-target and ownership-not-acquired states. UNK-022 remains open for v2 implementation closure, live use, effective target validation, records, calibration/overhead, capture, execution, publication, and evidence.

...
| UNK-022 | Narrowed by R29–R34: the semantic mapping, clocks/resource/file/procfs ABI, four-counter perf ABI, minimum first descriptive B1/D1 sources, non-live orchestration, and internal live-wrapper adapter are frozen and deterministically implemented through the R32 implementation closed by R33. R34 records that closed, unmerged PR #114 is not evidence and created no public compatibility obligation, preserves v1, and freezes a separate v2 representation for unsupported compile targets and ownership never acquired plus an exhaustive synthetic gate. It does not implement or invoke the boundary. Its strongest classification remains `preflight_subset_ready`; Fedora-release/effective-target validation remains unresolved. Live interface use, retained host observations, record schemas/producers/validators, calibration/overhead, capture, tracefs for confirmation or attribution/loss claims, execution, and evidence remain open. |
...
R34 records the governance conflict found at closed, unmerged PR #114 exact head `41d30f3484609b6b6ec03918bfd04b03ac56273a`: green workflows did not make its invented v1 states or incomplete synthetic coverage mergeable; it is not evidence and created no public compatibility obligation. It preserves R33 v1 and freezes a distinct v2 correction with truthful unsupported-target and ownership-not-acquired states. UNK-022 remains open for v2 implementation closure, live use, effective target validation, records, calibration/overhead, capture, execution, publication, and evidence.

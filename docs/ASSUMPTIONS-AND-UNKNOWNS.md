...
| UNK-020 | Narrowed by R5/R6 and R9: all B0–B3 documentation profiles/mappings are frozen, and the Slice A Rust 1.89.0 toolchain/build is frozen. Slice A implementation, later-slice and benchmark-series toolchains, effective-configuration validation, and execution evidence remain unresolved. |

...
| UNK-014 | R4 selects bare-metal Bosgame M5/Fedora 43 and defines conditional Linux durability semantics, but the exact CPU/kernel/clock/filesystem/mount/device/controller/cache/firmware/PLP stack and empirical survival behavior remain owner-capture-blocked. |

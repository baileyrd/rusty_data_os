...
| UNK-015 | Narrowed by R7: proposed process, kernel, physical-power/reset, storage-condition, and explicit-error mechanisms, evidence, apparatus validation, safety, contamination, and classification rules are frozen as design. Implementation, apparatus validation, physical validity detection, execution, and evidence remain open; R4 power-path limits still apply. |
...
| UNK-020 | Narrowed by R5/R6: all B0–B3 documentation profiles and mappings are frozen. Implementations, BLK-026 toolchain/series inputs, effective-configuration validation, and execution evidence remain unresolved. |
...
| UNK-022 | Narrowed by R7 for benchmark records: JSON/JCS serialization, epoch/monotonic nanoseconds, typed UUIDv4 identities, SHA-256 record/artifact digests, explicit missing states, deterministic validation, provenance/retention rules, and instrumentation method are frozen as design. Executable schemas/validators, storage provider, signing mechanism, implementation, calibration, and evidence remain open; workload serialization/digests remain separately open. |

The [EXP-0001 execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md) maps unknowns to gates. R5 resolves UNK-001 and the B1 physical/integrity portion of UNK-012. [R6](experiments/EXP-0001/R6-SQLITE-ROCKSDB-EXECUTION-PROFILES.md) narrows UNK-020/021 through exact B2/B3 design profiles without empirical proof. [R7](experiments/EXP-0001/R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) narrows UNK-015/022 as documentation design. R7 is complete and R8 is next; BLK-015, implementation, effective validation, execution, and evidence remain open.

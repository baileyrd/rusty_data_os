...
The [EXP-0001 execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md) maps unknowns to gates. R5 resolves UNK-001 and the B1 physical/integrity portion of UNK-012. R6 narrows UNK-020/021. [R7](experiments/EXP-0001/R7-BENCHMARK-RECORDS-ARTIFACTS-INSTRUMENTATION-FAULTS.md) narrows UNK-015/018/019/022 without empirical proof. R7–R13 are complete documentation/governance inputs. Slices A and B are closed as correctness-validation evidence; R13 closes R12 as the BLK-006/007 documentation freeze and prospectively authorizes only a BLK-008 documentation freeze; generator implementation, BLK-008/009, BLK-015, later slices, effective validation, execution, and benchmark evidence remain open.

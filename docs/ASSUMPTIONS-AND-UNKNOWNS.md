...
| UNK-014 | R4 selects bare-metal Bosgame M5/Fedora 44 and defines conditional Linux durability semantics, and four intended paths. An externally reviewed but unretained capture supports Fedora 44, firmware identity, and the paths’ current nearest-parent XFS/LVM/NVMe association; exact CPU/kernel/clock, final path placement, cache/flush/FUA/PLP, retained provenance, and empirical survival remain blocked. |

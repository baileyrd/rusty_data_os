...
- **externally reviewed observation** — a non-sensitive value reported from an owner-reviewed artifact that is not repository-retained; it guides follow-up but is not a verified target fact.

...
| RQ-002 | What minimal semantics and measurements are required before event-ingestion implementation? | Active; semantic-envelope and lifecycle/durability outputs complete, remaining readiness outputs incomplete | EXP-0000 |

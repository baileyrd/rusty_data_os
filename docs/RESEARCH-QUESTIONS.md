...
| RQ-003 | What are the cost and correctness characteristics of single-event ingestion at explicit durability boundaries? | Planned; R1–R7 documentation is complete; record/artifact/instrumentation design is frozen, while owner-dependent fault apparatus, BLK-015, R8 thresholds/statistics, implementation, evidence, and execution remain open; R8 is next | EXP-0001 and its execution-readiness plan |

...
|---|---|---|---|
| RQ-001 | Can one canonical information history support multiple independently optimized representations with acceptable performance and complexity? | Active; unproven | HYP-0001, [HYP-0002](hypotheses/HYP-0002-memory-convergence.md) and staged experiments |
...
externally; no performance conclusion follows here. Merge plan step 2
authorizes HYP-0002 to test RQ-001/RQ-004 through independent Memory row/column
reconstruction. Host entries bind each series to its snapshot and trace hash.

...
| RQ-002 | What minimal semantics and measurements are required before event-ingestion implementation? | Active; semantic-envelope output complete, remaining readiness outputs incomplete | EXP-0000 |

...
| RQ-002 | What minimal semantics and measurements are required before event-ingestion implementation? | Active; semantic-envelope, workload, lifecycle/durability, and crash/recovery-procedure outputs complete; remaining readiness outputs incomplete | EXP-0000 |
...
The recommended next bounded RQ-002 output is baseline selection and configuration against the frozen workload contract. This recommendation is not approval to configure or execute baselines.

...
**Status:** Phase 1 planning/readiness — Slice A and Slice B correctness gates passed; R12 closed as BLK-006/007 documentation design; only a BLK-008 documentation freeze is prospectively authorized
**North star:** Represent once. Materialize many. Optimize always.
**Verified starting `main` checkpoint:** `1a891f3` (PR #54 / R12)

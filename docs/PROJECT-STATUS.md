...
## R33 implementation pending review

The R33-authorized target-preflight boundary and deterministic serializer are present on this branch with synthetic tests. This branch state remains pending exact-head external review and CI and is not completed correctness evidence, target validation, live observation, or execution. All R33 exclusions remain in force.

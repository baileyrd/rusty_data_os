...
**Status:** Phase 1 planning/readiness — Slice A and Slice B correctness gates passed; BLK-006/007 frozen as documentation design; generator implementation and execution remain unauthorized
**North star:** Represent once. Materialize many. Optimize always.
**Verified starting `main` checkpoint:** `629d74e` (PR #52 / R11)

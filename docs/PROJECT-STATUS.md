...
[EXP-0001 — Immutable Event Ingestion](experiments/EXP-0001-immutable-event-ingestion.md) remains proposed and planned. Its [execution-readiness plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md) gates every implementation slice. R1–R7 are complete documentation inputs: R5 resolves BLK-001/003/016/017 and B0/B1 BLK-019, while R6 resolves BLK-018 and the B2/B3 design portion of BLK-019. R7 resolves BLK-010/021/022/025 as documentation design and constrains BLK-020 to future harness role/interface boundaries. BLK-015, BLK-020 architecture, BLK-023/024, BLK-026/027, implementation, apparatus/effective-configuration validation, empirical equivalence, evidence, and execution remain open. R8 is the next documentation-only increment; no matrix, threshold, sample-size, stopping-rule, or statistical plan begins here. Cargo bootstrap, fixtures, validators, adapters, capture, fault execution, benchmarks, and durability claims remain unauthorized.

...
**Status:** Phase 1 planning/readiness — Slice A and Slice B correctness gates passed; BLK-006/007 documentation freeze is the next prospective increment
**North star:** Represent once. Materialize many. Optimize always.
**Verified starting `main` checkpoint:** `dd7fc9d` (PR #50 / Slice B/B0)

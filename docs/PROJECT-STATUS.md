...
[EXP-0001 — Immutable Event Ingestion](experiments/EXP-0001-immutable-event-ingestion.md) remains proposed and planned. Its repository-recorded planning bridge is the [execution-readiness and staged-implementation plan](experiments/EXP-0001/EXECUTION-READINESS-PLAN.md), which inventories open blockers, orders readiness increments, and gates every implementation slice. Its [R1 physical-record, integrity, and recovery requirements](experiments/EXP-0001/R1-PHYSICAL-RECORD-INTEGRITY-RECOVERY-REQUIREMENTS.md) establish the requirements, and the [R5 physical-record/integrity/recoverable-commit contract](experiments/EXP-0001/R5-PHYSICAL-RECORD-INTEGRITY-AND-RECOVERABLE-COMMIT-CONTRACT.md) now resolves BLK-001/003 with stable documentation vectors. R5 is complete as documentation design: BLK-016/017 are resolved as design profiles and the B0/B1 portion of BLK-019 is complete. BLK-015, B2/B3, implementation, evidence, and execution remain open. R6 is the next documentation-only increment. Implementation, Cargo bootstrap, fixtures, validators, adapters, execution, benchmarks, and durability claims remain unauthorized.
